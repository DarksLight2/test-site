...
<div class="p-x-1 p-y-3">
    <form class="card card-block m-x-auto bg-faded form-width" method="POST" action="/register">
 ...
 <input class="form-control" id="first" name="name" value="{{ old('name') }}" type="text" placeholder="Имя"/>
 ...
 <label for="email">E-mail</label>
        ...
        <div class="form-group has-float-label">
            <input class="form-control" id="password" name="password_confirmation" type="password" placeholder="••••••••"/>
